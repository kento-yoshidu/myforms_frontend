    ...
    <>
      ...
      <Container>
        ...
        <Description>
          ...
          <p>また、変換不可文字を入力すると、その時点で「<span style={{ "color": "red" }}>半角小文字アルファベットと半角スペースのみ入力可能です。</span>」と表示され、さらにテキストボックスのborderが赤くなります。これが本当のリアルタイムバリデーションですね。</p>
          ...
          <p>そしてCSSでは、このaria-invalid属性の値に応じてスタイルを返るようにしています（コードは<a href="https://github.com/kento-yoshidu/MyForms/blob/053eda05aa5c9b2e9fb51ae4a16c4ee8a16e9435/pages/form1/style.module.css#L91-L95" target="_blink">こちら</a>）。ついつい「validate-error」などといったCSSクラスを付与してスタイルを切り替えてしまいそうな所ですが、よりセマンティックになるようにCSSを書いています。</p>
        </Description>
